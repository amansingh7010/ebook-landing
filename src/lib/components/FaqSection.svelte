	...
	const faqs = [
		{
			...
			answer:
				"This ebook provides a comprehensive guide to relocating to Canada, covering everything from securing the right visa and navigating Canada's legal system to finding the perfect place to live and integrating into the local culture. Whether you're moving for work, study, or retirement, this guide equips you with the essential knowledge and practical steps to make your transition as smooth as possible."
		},
		{
			question: 'Who is this ebook for?',
			answer:
				"This ebook is perfect for anyone considering a move to Canada, whether you're planning a short-term stay or a permanent relocation. It's designed for expats, retirees, students, and professionals who want to avoid common pitfalls and streamline their move. If you're looking for a detailed, step-by-step guide to help you every step of the way, this ebook is for you."
		},
		{
			question: 'How much does the ebook cost?',
			answer:
				'The ebook is priced at $10. This one-time purchase grants you immediate access to all the content, including detailed chapters, actionable checklists, and valuable resources that will save you time, money, and stress during your move to Canada.'
		},
		{
